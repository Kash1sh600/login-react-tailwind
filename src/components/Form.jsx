        ...
        <div className='bg-white px-10 py-20 rounded-3xl border-2 border-gray-200'>
           ...
           <div className='mt-8'>
              ...
              <form>
                 ...
                 <input
                    className='w-full border-2 border-gray-100 rounded-xl p-4 mt-1 bg-transparent form-control'
              ...
              <div className='mt-8 flex justify-between items-center'>
                ...
                <div className='mt-8 flex flex-col gap-y-4'>
                    <button type='submit' className='active:scale-[.98] active:duration-75 hover:scale-[1.01] ease-in-out transition-all py-3 rounded-xl bg-red-400 text-white text-lg font-bold'>
                    Sign in
                    </button>
                ...
                <div className='mt-8 flex justify-center items-center'>
                    ...
                    <button className='text-red-600 text-base font-medium ml-2'>Sign up</button>
                </div>
            </div>
        </div>
    )   
